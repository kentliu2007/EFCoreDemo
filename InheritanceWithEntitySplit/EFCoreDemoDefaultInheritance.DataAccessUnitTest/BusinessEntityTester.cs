...
namespace EFCoreDemoDefaultInheritance.DataAccessUnitTest
{
    ...
    {
        private DbContextOptionsBuilder<EFCoreDemoDefaultInheritanceContext> _optionsBuilder = new DbContextOptionsBuilder<EFCoreDemoDefaultInheritanceContext>();
        private const string CONNECTIONSTRING = "Data Source = (local); Initial Catalog = EFCoreDemoA; Integrated Security = True";
        ...
        public void TestUser()
        {
            ...
            using (var context = new EFCoreDemoDefaultInheritanceContext(_optionsBuilder.Options))
            {
